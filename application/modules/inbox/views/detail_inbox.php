        ...
        <div class="card card-outline">
          <div class="card-header" style="background-color: #009999; color:#fff">
            <a href="#" onclick="window.history.back()" style="color: #fff;">
              <button type="button" class="btn btn-default btn-sm"><i class="fa fa-arrow-alt-circle-left"></i>&nbsp;Kembali</button>
            </a>
            ...
            <div class="card-body">
              <div class="mailbox-read-info">
                <h5><?php //echo $u['subject'] 
                    ?></h5>
                <h6 class="text-muted">RSU Kota Tangsel
                ...
                <div class="btn btn-default">
                  ...
                  if ($u['file'] != 'no-image.png') {
                    ...
                    if ($u['pesan_keluar'] != NULL) {
                      ...
                      <input type="file" name="foto" class="swalButtonSudahDibalas">';
                    } else {
                      echo '<i class="fas fa-paperclip"></i>
          ...
          <div class="card-footer">
            <div class="float-right">
              <?php
              if ($u['pesan_keluar'] == null) {
                echo '<button type="submit" class="btn btn-tosca"><i class="fas fa-paper-plane"></i> Balas</button>';
              } else {
                echo '<button type="button" class="btn btn-danger swalButtonSudahDibalas"><i class="fas fa-paper-plane"></i> Balas</button>';
              }
              ?>
            </div>
            <button type="button" class="btn btn-tosca" onclick="window.print()"><i class="fas fa-print"></i> Print</button>
          </div>
        </div>
      </form>
    </div>
          ...
          <div class="row">
            <div class="col-sm-12 border-right">
              <div class="description-block">
                ...
                <a href="<?php echo base_url('inbox/getAllPesanByIdUser/') . $i['id'] ?>">
                  <span class="badge badge-success"><?php echo $getJumlahPengaduanByidUser ?> Pengaduan &nbsp; <i class="fa fa-search"></i></span>
                </a>
              </div>
            </div>
          </div>
