  ...
  <div class="row justify-content-center">
      ...
      <div class="col-md-3">
        <div class="card card-widget widget-user">
          ...
          <div class="widget-user-image">
            <a href="<?php echo base_url('user/getFotoProfile/') . $i['id'] ?>" data-toggle="lightbox">
            ...
            <div class="row">
              <div class="col-sm-12 border-right">
                <div class="description-block">
                  <h5 class="text-muted">bidang <?php echo $i['bidang'] ?></h5>
    ...
    <div class="col-md-8 col-sm-12">
      <div class="card card-info">
        ...
        <div class="card-body">
          <?php foreach ($getProfileUser as $i) : ?>
            <form role="form" action="<?php echo base_url('user/update/') . $i['id'] ?>" method="post" enctype="multipart/form-data">
              <div class="row">
