    ...
    <div class="card-body p-0">
      <div class="mailbox-controls">
        <div class="float-right text-muted" style="font-size: 12px;">
          Total <?php echo $getAllOutbox['total_rows'] ?> Pesan
        </div>
      </div>
      <div class="table-responsive mailbox-messages">
        <!-- load view -->
        <?php $this->load->view('serverside_list_outbox') ?>
      </div>
    </div>
    <div class="card-footer p-0 mb-3">
      <div class="mailbox-controls">
        <div class="float-right text-muted" style="font-size: 12px;">
          Total Pesan Masuk <?php echo $getAllOutbox['total_rows'] ?> Pesan
        </div>
      </div>
    </div>
    <?php echo $getAllOutbox['pagination'] ?>
  </div>
</div>
...
<div class="modal fade" id="modal_history_forward">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-tosca">
        <h5 class="modal-title"> <i class="fa fa-envelope"></i> &nbsp; Detail Pesan Pengaduan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span></button>
      </div>
      <div class="modal-body">
