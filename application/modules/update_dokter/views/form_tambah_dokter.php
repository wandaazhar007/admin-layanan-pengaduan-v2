<div class="col-12 col-sm-12 col-md-4 text-center" style="position: fixed; z-index: 999; right: 12px; top: 50px;">
    ...
    <div class="col-md-8 col-sm-12">
      <div class="card card-info">
        <div class="card-header" style="background-color: #009999;">
          <h6 class="text-center">Form Tambah Dokter</h6>
        </div>
        <div class="card-body">
          <form role="form" action="<?php echo base_url('update_dokter/insert') ?>" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group input-group-sm">
                  ...
                  <input type="text" name="poliklinik" class="form-control" placeholder="poliklinik" value="<?php echo set_value('poliklinik') ?>">
              ...
              <div class="col-md-3 col-sm-12">
                <div class="form-group input-group-sm">
                  ...
                  <input type="text" name="senin" class="form-control col-md-6 col-sm-12" placeholder="00.00" value="<?php echo set_value('senin') ?>">
                  <small class="text-danger"><?php echo form_error('senin') ?></small>
                </div>
                <div class="form-group input-group-sm">
                  <label class="text-sm mb-0">Rabu</label>
                  <input type="text" name="rabu" class="form-control col-md-6 col-sm-12" placeholder="00.00" value="<?php echo set_value('rabu') ?>">
              ...
              <div class="col-md-3 col-sm-12" style="margin-left: -100px;">
                <div class="form-group input-group-sm">
                  ...
                  <input type="text" name="selasa" class="form-control col-md-6 col-sm-12" placeholder="00.00" value="<?php echo set_value('selasa') ?>">
                  <small class="text-danger"><?php echo form_error('selasa') ?></small>
                </div>
                <div class="form-group input-group-sm">
                  <label class="text-sm mb-0">Kamis</label>
                  <input type="text" name="kamis" class="form-control col-md-6 col-sm-12" placeholder="00.00" value="<?php echo set_value('kamis') ?>">
              ...
              <div class="col-md-3 col-sm-12" style="margin-left: -100px;">
                <div class="form-group input-group-sm">
                  ...
                  <input type="text" name="jumat" class="form-control col-md-6 col-sm-12" placeholder="00.00" value="<?php echo set_value('jumat') ?>">
