      ...
      <ul class="nav nav-pills flex-column">
        <li class="nav-item active">
          <a href="<?php echo base_url('inbox') ?>" class="nav-link">
            ...
            <span class="badge bg-primary float-right"><?php echo $this->wandalibs->countAllInbox() ?></span>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo base_url('outbox') ?>" class="nav-link">
            <i class="far fa-envelope"></i> Pesan Keluar
            <span class="badge bg-primary float-right"><?php echo $this->wandalibs->countAllOutbox() ?></span>
          </a>
        </li>
        <li class="nav-item">
