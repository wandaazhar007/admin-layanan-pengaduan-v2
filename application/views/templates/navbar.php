<nav class="main-header navbar navbar-expand navbar-info navbar-dark nav-legacy text-sm" style="background-color: #009999; color: #fff">
  <!-- Left navbar links -->
  <ul class="navbar-nav">
    <li class="nav-item">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="https://rsu.tangerangselatankota.go.id/" class="nav-link">Website RSU Kota Tangsel</a>
    </li>
  </ul>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <a href="<?php echo base_url('user/my_profile/getProfileUser/') . $this->session->userdata('id') ?>" class="dropdown-item">
          <!-- Message Start -->
          <div class="media">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <span class="dropdown-item dropdown-header"><?php echo $this->wandalibs->countLoginUserById($this->session->userdata('email')); ?> Notifikasi</span>
        <div class="dropdown-divider"></div>
        <?php
        $query = $this->wandalibs->_lastLoginUserById($this->session->userdata('email'));
        foreach ($query as $i) : ?>
          <a href="#" class="dropdown-item">
            <i class="fas fa-clock mr-2"></i>Login: <?= date('d F Y | h:i:s', $i['date_created']) ?>
